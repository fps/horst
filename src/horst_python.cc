...
PYBIND11_MODULE(lv2_horst, m)
{
  ...
  bp::class_<horst::jack_horst, horst::jack_horst_ptr> (m, "jack_horst", bp::dynamic_attr ())
    .def (bp::init<horst::plugin_ptr, std::string, bool>())
    .def ("set_control_port_value", &horst::jack_horst::set_control_port_value)
    .def ("get_control_port_value", &horst::jack_horst::get_control_port_value)
    .def ("set_midi_binding", &horst::jack_horst::set_midi_binding)
    .def ("get_midi_binding", &horst::jack_horst::get_midi_binding)
    .def ("get_number_of_ports", &horst::jack_horst::get_number_of_ports)
    .def ("get_port_properties", &horst::jack_horst::get_port_properties)
    .def ("set_enabled", &horst::jack_horst::set_enabled)
    .def ("set_control_input_updates_enabled", &horst::jack_horst::set_control_input_updates_enabled)
    .def ("set_control_output_updates_enabled", &horst::jack_horst::set_control_output_updates_enabled)
    .def ("set_audio_input_monitoring_enabled", &horst::jack_horst::set_audio_input_monitoring_enabled)
    .def ("set_audio_output_monitoring_enabled", &horst::jack_horst::set_audio_output_monitoring_enabled)
    .def ("get_jack_client_name", &horst::jack_horst::get_jack_client_name)
    .def ("save_state", &horst::jack_horst::save_state)
    .def ("restore_state", &horst::jack_horst::restore_state)
  ;
}
